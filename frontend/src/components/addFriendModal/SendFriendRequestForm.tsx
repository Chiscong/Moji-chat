    ...
    return (
        <form onSubmit={onSubmit} >
            ...
            <div className="space-y-4">
                <span className="success-message">Tìm thấy <span className="font-semibold">@{searchedUsername}</span> rồi kkk 😘 </span>
            </div>
            <div className="space-y-4">
                ...
                <Textarea
                    id="message" rows={3} placeholder="Kết bạn được không ?"
